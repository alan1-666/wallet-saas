...
func TestCloudHSMBackendDefaultProviderReturnsRuntimeErrorWithoutRealEnvironment(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("expected runtime error without a real cloudhsm environment")
	}
}

func TestCloudHSMBackendUsesNoopProviderWhenExplicitlyRequested(t *testing.T) {
	...
	if err == nil {
		t.Fatalf("expected noop provider error")
	}
