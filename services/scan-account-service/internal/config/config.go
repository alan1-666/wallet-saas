...
type Config struct {
	...
	OutgoingNotFoundThreshold    int
	OutgoingNotFoundGraceSeconds int
...
func Load() Config {
	cfg := Config{
		...
		OutgoingNotFoundThreshold:    atoi(getenv("SCAN_OUTGOING_NOT_FOUND_THRESHOLD", "3"), 3),
		OutgoingNotFoundGraceSeconds: atoi(getenv("SCAN_OUTGOING_NOT_FOUND_GRACE_SECONDS", "45"), 45),
