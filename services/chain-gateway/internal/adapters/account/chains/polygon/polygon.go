...
import (
	...
	"wallet-saas-v2/services/chain-gateway/internal/adapters/account/chains/common/util"
...
func (c *ChainAdaptor) GetAccount(req *account.AccountRequest) (*account.AccountResponse, error) {
	...
	data := erc20Base.BuildErc20BalanceData(common.HexToAddress(req.Address))
